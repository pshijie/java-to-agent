...
<a href="/part1-foundation/ch01-what-is-agent" style="background:#f8fafc;color:#3b82f6;padding:6px 14px;border-radius:8px;border:1.5px solid #bfdbfe;text-decoration:none">第1章 初识智能体</a>
...
<span style="color:#94a3b8;font-size:16px">→</span>
<a href="/part2-paradigms/ch06-reflection" style="background:#f8fafc;color:#3b82f6;padding:6px 14px;border-radius:8px;border:1.5px solid #bfdbfe;text-decoration:none">第6章 Reflection</a>
</div>
...
- 本章的 `ainvoke` 异步接口在第5章 Plan-Solve 的流式执行和第6章 Reflection 的迭代优化中被大量使用
