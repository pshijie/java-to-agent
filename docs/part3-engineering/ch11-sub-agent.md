...
<div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;margin:16px 0;font-family:sans-serif;font-size:13px">
  ...
  <span style="color:#94a3b8;font-size:16px">→</span>
  <a href="/part4-enterprise/ch15-multi-agent-system" style="background:#f1f5f9;color:#64748b;padding:6px 14px;border-radius:8px;border:1.5px solid #e2e8f0;text-decoration:none">第15章 多Agent实战</a>
</div>
